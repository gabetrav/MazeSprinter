...
function touchedwallofcurrentcell(y, x) {
	...
	//debugging assertion
	if (y < 0 || y > (mazeHeight * cellSize)) {
		console.log("touchedwall being called out of bounds y", y);
	}
	else if (x < 0 || x > (mazeWidth * cellSize)) {
		console.log("touchedwall being called out of bounds x", x);
	}
	...
	if (gridrow < 0 || gridrow > mazeHeight) {
		console.log("gridrow out of bounds", gridrow);
	}
	console.log("touchedwall: gridrow " , gridrow, "gridcol", gridcol);
